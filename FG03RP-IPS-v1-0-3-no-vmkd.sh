...
figlet FG03RP-IPS
##tool-info
echo "FG03RP-IPS-Edition.ver-1.0.3"
echo "Tool-Ver:1.0.3"
echo "Coder:BH-BaSH"
echo "TW:BH_BASH_BPS"
...
if [ $y_or_n = Y ] ; then
    ...
    nslookup $IP_main ; ipcalc $IP_main ; ipcount $IP_main - $IP_subnet ; fping $IP_main $IP_subnet ; ping -c 5 $IP_main ; nmap $IP_main ; ipfetch $IP_main ; whois $IP_main
    echo "調査が完了しました"
    echo "終了します"
